...
from model.parts.general_state_updates import s_update_change_datetime, s_update_action_type, s_record_arbitrageur_trade
    ...
    if add_arbitrage:
        blocks['partial_state_update_blocks'].append({
            ...
            'variables': {
                ...
                'change_datetime': s_update_change_datetime,
                'spot_prices': s_update_spot_prices,
                'arbitrageur_trade': s_record_arbitrageur_trade,
            }
        })
    return blocks
