...
class BPool:
    ...
    def routes():
        return {
            "swap": BPool.s_swap_exact_amount_in,
            "join": BPool.s_join_pool,
            "join_swap": BPool.s_join_swap_extern_amount_in,
            "exit_swap": BPool.s_exit_swap_extern_amount_out
        }
    ...
    def s_update_pool(params, substep, state_history, previous_state, policy_input):
        ...
        state_update_function = BPool.routes()[action_type]
    ...
    def s_join_swap_extern_amount_in(params, substep, state_history, previous_state, policy_input):
        ...
        total_weight = BPool.calculate_total_denorm_weight(pool)
